...
# Embedded file name: .\src\test\custom_ui\widget.py
# Compiled at: 2021-08-19 19:18:58
# Size of source mod 2**32: 21212 bytes
...
class Button(WidgetBase):
    ...
    def __init__(self):
        ...
        action_enum_dict = {'on_click':widget_action.button.on_click, 
         'on_press_down':widget_action.button.on_press_down, 
         'on_press_up':widget_action.button.on_press_up}
        action_value_type_list_dict = {widget_action.button.on_click: (), 
    ...
    def set_background_color(self, *background_color):
        if len(background_color) != 4:
            return False
        params = (('int32', background_color[0]),
         (
...
class Toggle(WidgetBase):
    ...
    def __init__(self):
        ...
        action_enum_dict = {'on_value_changed': widget_action.toggle.on_value_change}
        action_value_type_list_dict = {widget_action.toggle.on_value_change: ('bool', )}
        self.update_action_enum_dict(action_enum_dict)
        self.update_action_value_type_list_dict(action_value_type_list_dict)
        self.create()
    ...
    def set_checkmark_color(self, *checkmark_color):
        if len(checkmark_color) != 4:
            return False
        params = (('int32', checkmark_color[0]),
         (
...
class Slider(WidgetBase):
    ...
    def __init__(self):
        ...
        action_enum_dict = {'on_value_changed': widget_action.slider.on_value_change}
        action_value_type_list_dict = {widget_action.slider.on_value_change: ('int32', )}
        self.update_action_enum_dict(action_enum_dict)
        self.update_action_value_type_list_dict(action_value_type_list_dict)
        self.create()
...
class Dropdown(WidgetBase):
    ...
    def __init__(self):
        ...
        action_enum_dict = {'on_value_changed': widget_action.dropdown.on_value_change}
        action_value_type_list_dict = {widget_action.dropdown.on_value_change: ('int32', )}
        self.update_action_enum_dict(action_enum_dict)
        self.update_action_value_type_list_dict(action_value_type_list_dict)
        self.create()
    ...
    def set_item_text_color(self, *item_text_color):
        if len(item_text_color) != 4:
            return False
        params = (('int32', item_text_color[0]),
         (
    ...
    def set_item_background_color(self, *item_background_color):
        if len(item_background_color) != 4:
            return False
        params = (('int32', item_background_color[0]),
         (
    ...
    def set_item_checkmark_color(self, *item_checkmark_color):
        if len(item_checkmark_color) != 4:
            return False
        params = (('int32', item_checkmark_color[0]),
         (
...
class InputField(WidgetBase):
    ...
    def __init__(self):
        ...
        action_enum_dict = {'on_value_changed': widget_action.toggle.on_value_change}
        action_value_type_list_dict = {widget_action.toggle.on_value_change: ('string', )}
        self.update_action_enum_dict(action_enum_dict)
        self.update_action_value_type_list_dict(action_value_type_list_dict)
        self.create()
    ...
    def set_hint_text_color(self, *hint_text_color):
        if len(hint_text_color) != 4:
            return False
        params = (('int32', hint_text_color[0]),
         (
